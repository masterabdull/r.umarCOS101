...
fn main() {
    println!("Welcome to abduls diner!!!");

    println!("here is our lovely menu");
    ...
    println!("Hi there, please enter your order  (P, F, A, E, W):");
    ...
    println!(" good choice!,please enter your quantity");
    ...
    println!("The total cost of your order is: N{}", total_cost);
